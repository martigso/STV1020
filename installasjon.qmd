# 2. Installasjonsguide {#installasjon}
...
Dersom du trenger hjelp eller har problemer med installasjon/oppdatering så kan du komme på `r emo::ji("hot_beverage")` [kodekafé](https://www.sv.uio.no/isv/english/research/courses/coffee-and-coding/) `r emo::ji("hot_beverage")`.
...
`r emo::ji("computer")` *Windows* `r emo::ji("computer")`
...
`r emo::ji("apple")` *Mac* `r emo::ji("apple")` 
...
`r emo::ji("penguin")` *Linux (Ubuntu 20.04+)* `r emo::ji("penguin")`
