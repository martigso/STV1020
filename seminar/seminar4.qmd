---
title: "Seminar 3 -- Missingverdier, statistikk og bivariate sammenhenger"
format: 
  html:
    code-fold: false
---
...
write.csv(datasett, file = "der/du/vil/lagre")

```

Datasettet heter `internett.csv` og omhandler internettbruken til italienere. Det betstår av et utvalg variabler hentet fra European Social Survey (ESS) runde 9 (2018). Enhetene er italienske statsborgere og samlet innholder datasettet 2745 observasjoner og 5 variable: 
